...
(function() {
   ...
   */
  var init = () => {
    for (var i = 0; i < numberButtons.length; i++) numberButtons[i].addEventListener('click', handleNumberButtonClick, false);
    for (var i = 0; i < operationButtons.length; i++) operationButtons[i].addEventListener('click', handleOperationButtonClick, false);
